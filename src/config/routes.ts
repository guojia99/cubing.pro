...
export const APP_ROUTES: AppRoute[] = [
  ...
  { id: "tool-bld-d", name: "BLD 德语", pattern: "/tools/bld-d", implType: "frontend-only", renderMode: "client-spa", pageComponent: "Tools/Bld/BldMeor.tsx", tags: ["tool"] },
  ...
  { id: "tool-team-match", name: "团体赛", pattern: "/tools/team-match", implType: "hybrid", renderMode: "client-spa", pageComponent: "Tools/TeamMatch/TeamMatch.tsx", tags: ["tool"] },
  { id: "draw-sq1", name: "SQ1 打图", pattern: "/draw-tools/sq1-d", implType: "frontend-only", renderMode: "client-spa", pageComponent: "Tools/Draws/SQ1Draw.tsx", tags: ["tool"] },
  { id: "draw-minx", name: "五魔方打图", pattern: "/draw-tools/minx-d", implType: "frontend-only", renderMode: "client-spa", pageComponent: "Tools/Draws/MinxDraw.tsx", tags: ["tool"] },
  { id: "draw-sk", name: "Skewb 打图", pattern: "/draw-tools/sk-d", implType: "frontend-only", renderMode: "client-spa", pageComponent: "Tools/Draws/SkDraw.tsx", tags: ["tool"] },
  { id: "draw-py", name: "Pyraminx 打图", pattern: "/draw-tools/py-d", implType: "frontend-only", renderMode: "client-spa", pageComponent: "Tools/Draws/PyDraw.tsx", tags: ["tool"] },

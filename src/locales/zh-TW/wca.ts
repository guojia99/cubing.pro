export default {
  ...
  'wca.milestone.help.first_333_average_sub10':
    '依大賽日與輪次順序，首次三階平均嚴格低於 10.00 秒；下列出此前每一筆三階輪次（含無有效平均者）。',
  'wca.milestone.help.first_triple_podium_competition':
    '依參賽順序，第一場在決賽類輪次中至少三個不同項目進入前三的比賽。',
  'wca.milestone.help.busy_competition_year':
    '某一自然年內 WCA 場次超過 15（至少 16 場）；在當年最後一場（依開賽日）生成一條，並標註當年總場數。',
  'wca.milestone.help.multi_gold_single_comp':
    '同一場比賽中，在決賽類輪次至少兩個不同項目奪金；每場符合條件的比賽各生成一條。',

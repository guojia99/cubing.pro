export default {
  ...
  'wca.milestone.help.first_333_average_sub10':
    'First time your 3x3 average is strictly under 10.00 seconds (competition and round timeline). Lists every prior 3x3 round (including rounds without a valid average).',
  'wca.milestone.help.first_triple_podium_competition':
    'First competition (by start date order) where you earn podiums in at least three different events in final-style rounds.',
  'wca.milestone.help.busy_competition_year':
    'A calendar year with more than 15 WCA competitions (at least 16). One milestone on the last competition of that year, with the yearly count.',
  'wca.milestone.help.multi_gold_single_comp':
    'One competition with gold in at least two different events (final-style rounds). Each qualifying competition generates one milestone.',

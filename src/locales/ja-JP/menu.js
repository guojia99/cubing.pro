export default {
    ...
    'menu.ExternalLinks.homeTip': 'ホームにピン留めされたリンクはまだありません。管理画面の Cubing Hub で最大 3 件までピン留めできます。',
    'menu.ExternalLinks.homeSectionTitle': '外部ナビ',
    'menu.ExternalLinks.viewAll': 'すべて見る',
    'menu.ExternalLinks.adminCardDesc': 'ホームと一覧ページの Cubing Hub のグループ・並び・ピン留めを管理',

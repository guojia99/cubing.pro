...
function collectFormulaRandomPick() {
    const result = {};
    try {
        for (let i = 0; i < localStorage.length; i++) {
            const key = localStorage.key(i);
...
export function importPracticeConfig(jsonStr) {
    try {
...
//# sourceMappingURL=practiceConfigExport.js.map
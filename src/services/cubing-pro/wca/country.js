...
let cachedCountries = [];
export function getCachedWcaCountries() {
 ...
 */
export function resolveWcaCountryRecord(raw, list) {
 ...
 */
export function getWcaCountryLabel(raw, list) {
...
export async function CountryList() {
    const response = await Request.get(`/wca/country`, {
        headers: AuthHeader(),
    });

...
export const RecordTagWithResult = (resultVal, resultId, isBest, isPB, recordMap) => {
    let tag = '';
    if (isPB) {
        tag = 'PB';
    }
    const r_keys = ['NR', 'GR', 'CR'];
...
export const RecordTag = (record, values) => {
...
//# sourceMappingURL=record_tag.jsx.map
...
'19': React.lazy(() => import(/* webpackChunkName: "p__Tools__Draws__SQ1Draw" */'@/pages/Tools/Draws/SQ1Draw.tsx')),
'20': React.lazy(() => import(/* webpackChunkName: "p__Tools__Draws__MinxDraw" */'@/pages/Tools/Draws/MinxDraw.tsx')),
'21': React.lazy(() => import(/* webpackChunkName: "p__Tools__Draws__SkDraw" */'@/pages/Tools/Draws/SkDraw.tsx')),
...
'25': React.lazy(() => import(/* webpackChunkName: "p__Tests__Test" */'@/pages/Tests/Test.tsx')),
'26': React.lazy(() => import(/* webpackChunkName: "p__Static__Static" */'@/pages/Static/Static.tsx')),
'27': React.lazy(() => import(/* webpackChunkName: "p__Events__Events" */'@/pages/Events/Events.tsx')),
'28': React.lazy(() => import(/* webpackChunkName: "p__Competition__Competitions" */'@/pages/Competition/Competitions.tsx')),
'29': React.lazy(() => import(/* webpackChunkName: "p__Competition__Competition" */'@/pages/Competition/Competition.tsx')),
'30': React.lazy(() => import(/* webpackChunkName: "p__Player__Players" */'@/pages/Player/Players.tsx')),
'31': React.lazy(() => import(/* webpackChunkName: "p__Player__Player" */'@/pages/Player/Player.tsx')),
'32': React.lazy(() => import(/* webpackChunkName: "p__Static__Static" */'@/pages/Static/Static.tsx')),
'33': React.lazy(() => import(/* webpackChunkName: "p__Events__Events" */'@/pages/Events/Events.tsx')),
'34': React.lazy(() => import(/* webpackChunkName: "p__Competition__Competitions" */'@/pages/Competition/Competitions.tsx')),
'35': React.lazy(() => import(/* webpackChunkName: "p__Competition__Competition" */'@/pages/Competition/Competition.tsx')),
'36': React.lazy(() => import(/* webpackChunkName: "p__Player__Players" */'@/pages/Player/Players.tsx')),
'37': React.lazy(() => import(/* webpackChunkName: "p__Player__Player" */'@/pages/Player/Player.tsx')),

...
import { eventOrder, EXCLUDED_EVENTS } from '@/views/Wca/utils/events';
import { Select, Table, Spin, Switch, Space, Tag, Card } from 'antd';
import React, { useEffect, useMemo, useState } from 'react';
import { useIntlMessage } from '@/hooks/useIntlMessage';
import './AllEventsAchievementRank.css';
...
function parseCompletedEvents(record: AllEventAvgPersonResults): string[] {
  if (record.doneEventList?.length) return record.doneEventList;
  try {
...
const AllEventsAchievementRank: React.FC = () => {
  ...
  return (
    <div className="all-events-achievement-rank">
      <Card size="small" variant="outlined" className="stats-rank-filter-card">
      ...
      <Card size="small" variant="outlined" className="stats-rank-table-card">

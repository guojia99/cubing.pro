...
import { roundNameMap, roundSortOrder } from '@/views/Wca/utils/events';
...
import './WCAPlayerStaticsTabResultsWithComps.css';
  ...
  const columns: ColumnsType<WCAResult & { showEvent?: boolean; eventId?: string }> = [
    ...
    },
    {
      ...
      render: (best, record) => {
        ...
        return (
          <Space orientation="horizontal" size={4} style={{ justifyContent: 'flex-end' }}>
            <span
              style={{

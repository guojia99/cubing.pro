...
import { secondTimeFormat } from "@/views/Wca/utils/wca_results";

import "./ProportionEstimation.css";
...
export function ProportionEstimationView() {
  ...
  return (
    <div className="proportion-page">
      ...
      <Card className="proportion-controls" variant="borderless" loading={loading}>
        <Row gutter={[16, 16]} align="middle">
          <Col xs={24} md={10} lg={8}>
            <div className="proportion-field-label">
              {intl.formatMessage({ id: "wca.proportion.fieldType" })}
            </div>
            <Select
          ...
          <Col xs={24} md={14} lg={10}>
            <div className="proportion-field-label">
              {intl.formatMessage({ id: "wca.proportion.fieldWr" })}
            </div>
            <Segmented
        ...
        {data && !loading && data.sample_count < 5 && (
          <Alert
            type="warning"
            showIcon
      ...
      >
        <div className="proportion-algorithm-modal-body">
          <MarkdownViewer
            content={intl.formatMessage({ id: "wca.proportion.algorithmMd" })}

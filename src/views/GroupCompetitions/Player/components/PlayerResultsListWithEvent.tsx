...
import { BOBestGroup, BORecentGroup } from '@/views/GroupCompetitions/Player/components/BestBoGroup';
import RollingQuantileChart from '@/views/GroupCompetitions/Player/components/Echarts/RollingQuantileChart';
import ScoreRangeChart from '@/views/GroupCompetitions/Player/components/Echarts/ScoreRangeChart';
import SuccessRateBox from '@/views/GroupCompetitions/Player/components/SuccessRateBox';

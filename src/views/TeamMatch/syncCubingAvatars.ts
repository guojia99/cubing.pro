import { throttleBeforeCubingAvatarRequest } from '@/views/TeamMatch/wcaRequestThrottle';
import { fetchCubingAvatarUrl } from '@/views/TeamMatch/utils/cubingAvatar';
import type { Player } from '@/views/TeamMatch/types';
import { playersWithWcaId } from '@/views/TeamMatch/syncWcaAvatars';

import type { BracketSlot16, TeamMatchSession } from '@/views/TeamMatch/types';
import { MIN_TEAMS } from '@/views/TeamMatch/types';
import { schoolIdForDrawPairing } from '@/views/TeamMatch/teamClassify';
import { rankedBracketTeamIds, teamSeedingSum } from '@/views/TeamMatch/seedingMath';

import {
  ...
  regionsToFlat,
  syncBronzeToSession,
} from '@/views/TeamMatch/bracketGen';
import { randomizeDraw } from '@/views/TeamMatch/drawRandom';
import {
  buildElimGroupMatches,
  defaultEliminationState,
  groupTeamIdsRandom,
  isEliminationGroupMatch,
} from '@/views/TeamMatch/eliminationDraw';
import { computeMainBracketTeamIds } from '@/views/TeamMatch/eliminationResolve';
import { appendMockGroups, buildMockTeamMatchData16 } from '@/views/TeamMatch/mockLocal';
import { computeMultiTeamPkSettlement, computePkSettlement } from '@/views/TeamMatch/pkSettlement';
import { allRankedActiveTeamIds, pickSeedTeamIds } from '@/views/TeamMatch/seedingMath';
import { createEmptySession, normalizeSession } from '@/views/TeamMatch/sessionFactory';
import type {
  BracketMatch,

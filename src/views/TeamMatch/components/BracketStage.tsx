import { exportBracketElementToPng, formatBracketExportFilename } from '@/views/TeamMatch/bracketExportPng';
import { semiLoserPair } from '@/views/TeamMatch/bracketComplete';
import BracketFitTeamName from '@/views/TeamMatch/components/BracketFitTeamName';
import LiveSettingsButton from '@/views/TeamMatch/components/LiveSettingsButton';
import PkArenaFullscreen from '@/views/TeamMatch/components/PkArenaFullscreen';
import PkModal from '@/views/TeamMatch/components/PkModal';
import { bracketSettingsToCssVars, type LiveUISettings } from '@/views/TeamMatch/liveUiSettings';
import {
  formatPlayerSingleAverageLine,
  schoolNameForPlayer,
  seedingEntryForPlayer,
} from '@/views/TeamMatch/playerBracketDisplay';
import { buildPkTemplateRows } from '@/views/TeamMatch/sessionReducer';
import { useTeamMatchStore } from '@/views/TeamMatch/TeamMatchContext';
import type { BracketMatch, PkPlayerResult, Team } from '@/views/TeamMatch/types';

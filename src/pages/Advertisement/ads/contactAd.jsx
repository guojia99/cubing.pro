...
/** 内置广告：欢迎联系定制打广告 */
export const ContactAdThumbnail = () => {
    ...
    return (<div style={{
      ...
      <a href="mailto:guojia09900@gmail.com" style={{ color: token.colorPrimary, fontSize: 15, fontWeight: 500 }}>
        guojia09900@gmail.com
      </a>
    </div>);
};
/** 详情页（内置广告一般不单独展示，可复用缩略图内容） */
export const ContactAdFullContent = () => {
    return <ContactAdThumbnail />;
};
//# sourceMappingURL=contactAd.jsx.map
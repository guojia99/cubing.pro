...
const HistoricalRank = () => {
    ...
    const columns = [
        {
            ...
            width: 70,
            fixed: 'left',
            render: (_, record) => isWorld ? record[rankKey] : record[countryRankKey],
        },
        {
    ...
    return (<div className="historical-rank">
      ...
      <Card size="small" bordered className="stats-rank-filter-card">
        ...
        <div className="filter-item">
          ...
          <Select size="small" value={year} onChange={setYear} options={years.map((y) => ({ value: y, label: String(y) }))} className="filter-select"/>
        </div>
        <div className="filter-item">
      ...
      <Card size="small" bordered className="stats-rank-table-card">
        <Spin spinning={loading}>
          <div className="table-wrapper">
            <Table dataSource={data} columns={columns} rowKey="wcaId" size="small" scroll={{ x: 600 }} pagination={{
            current: page,
            pageSize,
            total,
...
//# sourceMappingURL=HistoricalRank.jsx.map
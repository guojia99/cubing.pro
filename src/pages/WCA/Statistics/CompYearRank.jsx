...
const CompYearRank = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 200,
            ellipsis: true,
            render: (_, record) => WCALinkWithCnName(record.personID, record.personName),
        },
      ...
      <Card size="small" bordered className="stats-rank-table-card">
        <Spin spinning={loading}>
          <div className="table-wrapper">
            <Table dataSource={data} columns={columns} rowKey={(r) => `${r.personID}-${r.year}-${r.eventID}-${r.isAvg}-${r.rank}`} size="small" scroll={{ x: 600 }} pagination={{
            current: page,
            pageSize,
            total,
...
//# sourceMappingURL=CompYearRank.jsx.map
...
const WCAPlayerDetails = ({ wcaProfile, wcaResults }) => {
    const intl = useIntl();
    ...
    const columns = [
        {
            ...
            render: (country_iso2) => {
                ...
                return (<Space>
            <span className={`fi ${ct} fi-3x`} style={{ marginRight: 8, minWidth: 20 }} title={getCountryNameByIso2(country_iso2)}/>
        ...
        },
        {
          ...
          <a href={wcaProfile.thumb_url} target="_blank" rel="noopener noreferrer">
            <Image src="https://cubing.com/f/images/wca.png" alt="WCA Logo" width={16} height={16} preview={false}/>
          </a>
          <a href={`https://cubing.com/results/person/${wcaProfile.wcaId}`} target="_blank" rel="noopener noreferrer">
            <Image src=" https://cubing.com/f/images/icon196.png" alt="Cubing China Logo" width={16} height={16} preview={false}/>
          </a>
        ...
        },
        {
            ...
            key: 'competition',
            align: 'center',
            render: (count) => (<Badge count={count} style={{ backgroundColor: '#52c41a' }} overflowCount={99999}/>),
        },
        {
    ...
    return (<div className="wca-player-container">
      <Card hoverable style={{ width: '100%', margin: '0 auto', borderRadius: 16 }} bordered={false}>
        {/* 头像与姓名 */}
        <div className="header-section">
          <Avatar src={wcaProfile.thumb_url} alt={intl.formatMessage({ id: 'wca.playerDetails.avatarAlt' }, { name: wcaProfile.name })} size={100}/>
        ...
        <div style={{ overflowX: 'auto', margin: '0 -1px' }}>
          <Table columns={columns} dataSource={data} pagination={false} bordered size="middle" scroll={{ x: 'max-content' }} style={{
            borderRadius: 8,
            textAlign: 'center',
            minWidth: 500,
        }}/>
...
//# sourceMappingURL=PlayerDetails.jsx.map
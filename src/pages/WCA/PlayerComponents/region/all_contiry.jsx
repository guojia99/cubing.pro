...
export const countryIso2ToChinese = {
    CN: '中国',
    TW: '中国台湾',
    HK: '中国香港',
    MO: '中国澳门',
...
/**
 * 根据ISO2国家代码获取中文名称
 * @param iso2Code - ISO2国家代码
 * @returns 对应的中文名称，如果不存在则返回undefined
 */
export function getCountryNameByIso2(iso2Code) {
    if (!iso2Code || typeof iso2Code !== 'string')
        return '';
...
const ZH_TW_ISO2_OVERRIDE = {
    CN: '中國',
    TW: '中國台灣',
    HK: '中國香港',
    MO: '中國澳門',
};
function regionNameIntl(iso2, intlLocales) {
 ...
 */
export function getCountryDisplayName(iso2Code, fallbackName) {
    if (!iso2Code || typeof iso2Code !== 'string')
        return fallbackName || '';
...
export function CountryAvatar(code) {
    let key = code.toLowerCase();
    if (key === "tw") {
        key = "cn";
    }
    return (<>
      <Avatar style={{ width: 16, height: 16, marginRight: 8 }} src={`https://flagcdn.com/${key}.svg`} size="small" shape="square"/>
    </>);
}
//# sourceMappingURL=all_contiry.jsx.map
...
const PlayerResultsRecord = lazy(
  () => import('@/pages/Player/PlayerComponents/PlayerResultRecord'),
);
const PlayerResultsNemesis = lazy(
  () => import('@/pages/Player/PlayerComponents/PlayerResultNemesis'),
);

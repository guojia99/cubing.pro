...
const PlayerResultsListWithComps = ({ events, results, records, comps, }) => {
    ...
    resultMap.forEach((resultList, compId) => {
        resultMap.set(compId, resultList.sort((a, b) => {
...
//# sourceMappingURL=PlayerResultsListWithComps.jsx.map
...
const DownloadExcelButton = ({ player, results }) => {
    const [data, setData] = useState();
    useEffect(() => {
        const da = results.sort((a, b) => {
    ...
    return (<Tooltip title="点击下载成绩列表">
      <AiOutlineDownload onClick={handleDownload} style={{ marginRight: 8, fontSize: 28, cursor: 'pointer' }}/>
    </Tooltip>);
};
export default DownloadExcelButton;
//# sourceMappingURL=PlayerResultDownloadButton.jsx.map
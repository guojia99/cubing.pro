...
const SuccessRateBox = ({ data }) => {
    ...
    return (<div style={{
      ...
      <Card bordered={false} style={{
        ...
        <Progress type="circle" percent={parseFloat(overallRate.toFixed(1))} strokeColor="#52c41a" width={100}/>
...
//# sourceMappingURL=SuccessRateBox.jsx.map
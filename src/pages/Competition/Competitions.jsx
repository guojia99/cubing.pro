...
const Competitions = () => {
    ...
    return (<>
      <ProTable title={() => {
            return <h2>赛事列表</h2>;
        }} size="small" columns={CompsTableColumns} onReset={resetParams} params={tableParams} rowClassName={rowClassNameWithStyleLines} request={async (params) => {
            // @ts-ignore
...
//# sourceMappingURL=Competitions.jsx.map
      ...
      <ProDescriptions column={1} title="比赛性质">
        ...
        {wca &&
          <ProDescriptions.Item label="认证">
            WCA认证<img src="https://cubing.com/f/images/wca.png" alt="wca_icon" style={{width: 16, marginLeft: 8}}/>
          </ProDescriptions.Item>
        }
  ...
  bodys.push(
    <div key={"__comps_detail_events_key"}>
      <ProDescriptions column={1} title="项目" key={"__comps_detail_events_key_ProDescriptions"}>
        <ProDescriptions.Item label="项目列表">
          {events}
        </ProDescriptions.Item>

        <ProDescriptions.Item label="报名费用">
          {/*"todo"*/}
        </ProDescriptions.Item>
      </ProDescriptions>
    </div>

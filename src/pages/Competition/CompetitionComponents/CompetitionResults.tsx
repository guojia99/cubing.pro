  ...
  if (result !== undefined) {
      ...
      items.push(
        {
          key: "trophy",
          label: "冠军",
          children: <CompetitionResultsWithTop comp={comp} results={result.data} events={events?.data.Events} topRank={1} event_divider={false}/>,
          icon: <TrophyOutlined/>,
        },
        {
          key: "top3",
          label: "前三",
          children: <CompetitionResultsWithTop comp={comp} results={result.data} events={events?.data.Events} topRank={3} event_divider={true}/>,
          icon: <SiCodeforces/>,
        },
        {
          key: "record",
    ...
    items.push(
      ...
      },
      {
        key: "players",
        label: "玩家",
        children: <CompetitionResultsWithPlayers comp={comp} results={result.data} events={events?.data.Events} />,
        icon: <BsPeople/>,
      }
    )
  }

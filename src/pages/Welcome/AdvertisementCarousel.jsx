...
const AdvertisementCarousel = () => {
    ...
    if (adList.length === 0)
        return null;
    return (<div className="ad-carousel-wrapper" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
      <div style={{ height: CAROUSEL_HEIGHT }} className="ad-carousel-container">
        <Carousel ref={carouselRef} dots={{ className: 'ad-carousel-dots' }} afterChange={setCurrent} autoplay={false} style={{ height: '100%' }}>
          {adList.map((ad) => {
            const Thumbnail = ad.Thumbnail;
            return (<div key={ad.key} className="ad-carousel-slide" style={{
                    height: CAROUSEL_HEIGHT,
                    padding: SLIDE_PADDING,
                    boxSizing: 'border-box',
                }}>
                <div className="ad-carousel-thumbnail-wrap" style={{
...
//# sourceMappingURL=AdvertisementCarousel.jsx.map
...
const Settings = () => {
    ...
    return (<PageContainer title={intl.formatMessage({ id: 'settings.title' })}>
      <Form form={form} layout="vertical" style={{ maxWidth: 480 }} initialValues={initial} onFinish={(v) => void onFinish(v)}>
        <Form.Item name="navTheme" label={intl.formatMessage({ id: 'settings.theme' })}>
          <Select options={[
        ...
        <Form.Item name="fontSizeBase" label={intl.formatMessage({ id: 'settings.fontSize' })} extra={intl.formatMessage({ id: 'settings.fontSizeHint' })}>

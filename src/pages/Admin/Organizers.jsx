...
export const MetaCards = (groups) => {
    ...
    for (let i = 0; i < groups.length; i++) {
        ...
        bodys.push(<Card title={groups[i].title} style={{ marginBottom: 16 }} key={i}>
...
//# sourceMappingURL=Organizers.jsx.map
...
import { acknowledgeCocktailSafety, hasAcknowledgedCocktailSafety, } from '../utils/cocktailSafetyAck';
const { Paragraph, Title } = Typography;
/**
 * 首次进入调酒相关页面时展示；确认后写入浏览器，列表与详情共用同一标记。
 */
const CocktailFirstVisitModal = () => {
    ...
    return (<Modal title="饮酒与使用提示" open={open} footer={<Button type="primary" block size="large" onClick={handleOk} style={{ borderRadius: 8 }}>
          我已阅读并知晓
        </Button>} closable={false} maskClosable={false} keyboard={false} centered width={520}>
...
//# sourceMappingURL=CocktailFirstVisitModal.jsx.map
...
const ExternalLinksHomeSection = () => {
    const intl = useIntl();
    ...
    return (<Card style={{
      ...
      <div className="external-links-home">
        ...
        <Spin spinning={loading}>
          {tops.length > 0 ? (<div className="external-links-home__grid">
              {tops.map((l) => (<ExternalLinkCard key={l.key} link={l}/>))}
            </div>) : (!loading && (<div style={{ fontSize: 14, color: token.colorTextSecondary, lineHeight: 1.6 }}>
...
//# sourceMappingURL=ExternalLinksHomeSection.jsx.map
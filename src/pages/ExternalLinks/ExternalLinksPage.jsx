...
const ExternalLinksPage = () => {
    ...
    return (<PageContainer title={intl.formatMessage({ id: 'menu.ExternalLinks' })} subTitle={intl.formatMessage({ id: 'menu.ExternalLinks.subtitle' })}>
      <Spin spinning={loading}>
        {empty ? (<Empty description={intl.formatMessage({ id: 'menu.ExternalLinks.empty' })}/>) : (data && (<div className="external-links-page-wrap">
              <Input.Search allowClear className="external-links-page__search" placeholder={intl.formatMessage({ id: 'menu.ExternalLinks.searchPlaceholder' })} value={search} onChange={(e) => setSearch(e.target.value)}/>
...
//# sourceMappingURL=ExternalLinksPage.jsx.map
 ...
 */
const STICKERING_NAMES_UNSORTED = [
    'OLL',
    'PLL',
    'LL',
    'EOLL',
...
const STICKERING_MATCH_ORDER = [...STICKERING_NAMES_UNSORTED].sort((a, b) => b.length - a.length || a.localeCompare(b));
/** 整魔方训练阶段：不使用 experimentalSetupAnchor: end（OLL/PLL/CMLL 等扩展贴纸仍用 end） */
const STICKERING_NO_END_ANCHOR = new Set([
    'F2L',
    'Cross',
    'Daisy',
    'EO',
...
function haystackContainsStickeringToken(haystack, token) {
 ...
 */
export function resolveTwistyStickering(classId, setName, groupName) {
...
export function twistyStickeringUsesSetupAnchorEnd(stickering) {
    return stickering !== null && !STICKERING_NO_END_ANCHOR.has(stickering);
}
//# sourceMappingURL=twistyStickering.js.map
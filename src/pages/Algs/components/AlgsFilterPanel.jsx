...
const AlgsFilterPanel = ({ data, selectedSets, selectedGroups, onSetToggle, onGroupToggle, onSetSelectAll, onSetDeselectAll, onGroupSelectAll, onGroupDeselectAll, compact = false, }) => {
    const intl = useIntl();
    ...
    return (<>
      <Card size="small" style={{ marginBottom: compact ? 12 : 16 }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
          {setKeys.map((name) => (<Button key={name} type={selectedSets.includes(name) ? 'primary' : 'default'} size="small" onClick={() => onSetToggle(name)} style={{
                borderRadius: 20,
          ...
          {setKeys
            ...
            return (<div key={setName}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                    ...
                    return (<Button key={key} type={selectedGroups.includes(key) ? 'primary' : 'default'} size="small" onClick={() => onGroupToggle(key)} style={{
                            borderRadius: 16,
...
//# sourceMappingURL=AlgsFilterPanel.jsx.map
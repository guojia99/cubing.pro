...
const AlgsFormulaCard = ({ cube, classId, setName, groupName, alg, setColorIndex = 0, formulaFontSize = 12, onClick, }) => {
    ...
    return (<Card hoverable onClick={onClick} size="small" style={{
            borderRadius: 10,
        ...
        <SvgRenderer svg={alg.image} maxWidth={180} maxHeight={320} style={{ marginTop: 12, marginBottom: 16 }}/>
...
//# sourceMappingURL=AlgsFormulaCard.jsx.map
...
function toneToSurfaceStyle(tone) {
    switch (tone) {
        case 'lightBlue':
            return {
 ...
 */
const AlgsTwisty333 = ({ alg, viewMode, experimentalStickering, panelTone = 'cream', bottomFaceColor = 'yellow', compact = false, className, style, }) => {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const player = new TwistyPlayer({
                ...
                ...(setupAnchorEnd ? { experimentalSetupAnchor: 'end' } : {}),
                background: 'none',
                hintFacelets: 'none',
    ...
    return (<div ref={hostRef} className={className} style={{
            width: '100%',
            marginLeft: 'auto',
            marginRight: 'auto',
...
//# sourceMappingURL=AlgsTwisty333.jsx.map
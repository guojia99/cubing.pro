...
const UsageInstructionsModal = ({ open, onClose }) => {
    const intl = useIntl();
    return (<Modal open={open} onCancel={onClose} title={intl.formatMessage({ id: 'algs.usageInstructions.title' })} footer={null} width={420}>
...
//# sourceMappingURL=UsageInstructionsModal.jsx.map
...
const PodiumStage = () => {
    ...
    if (!podium) {
        return (<div className="tmPodiumRoot">
      ...
      <div className="tmPodiumStage" aria-label="领奖台">
        ...
        <div className="tmPodiumLane tmPodiumLaneThird">
          <div className="tmPodiumCard">
            ...
            {thirdFourthShared ? (<div className="tmPodiumTeamStack">
              ...
              </div>) : (<Typography.Text strong className="tmPodiumTeam">
...
//# sourceMappingURL=PodiumStage.jsx.map
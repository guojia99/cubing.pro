import { buildTeamMatchJsonFile, downloadTeamMatchJson, parseTeamMatchImport, } from '@/pages/Tools/TeamMatch/teamMatchJson';
import { Button, Modal, Space, Typography, message } from 'antd';
import classNames from 'classnames';
import React, { useRef } from 'react';
import '../TeamMatch.less';
const TeamMatchJsonToolbar = ({ session, liveUISettings, onHydrate, onImportLiveUI, variant = 'light', }) => {
    ...
    return (<div className={classNames('tmJsonToolbar', { 'tmJsonToolbar--dark': dark })} role="region" aria-label="导入导出">
...
//# sourceMappingURL=TeamMatchJsonToolbar.jsx.map
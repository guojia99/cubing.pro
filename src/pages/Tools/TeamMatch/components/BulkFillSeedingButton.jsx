...
const BulkFillSeedingButton = ({ session, dispatch }) => {
    ...
    return (<Space direction="vertical" size="small" style={{ width: '100%', maxWidth: 420 }}>
      <Button type="default" loading={busy} disabled={disabled} onClick={() => void run()}>
        一键填充 WCA / One 成绩
      </Button>
      <Modal title="正在拉取 WCA / One 成绩" open={modalOpen} maskClosable={false} closable={false} keyboard={false} footer={<Button onClick={cancel} disabled={!busy}>
            取消
...
//# sourceMappingURL=BulkFillSeedingButton.jsx.map
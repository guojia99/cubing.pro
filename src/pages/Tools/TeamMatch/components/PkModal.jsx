...
const PkModal = ({ open, onClose, modalTitle = '录入 PK 成绩', match, teams, players, draft, onDraftChange, onSettle, onManualWinner, onReplay, onClearCurrent, }) => {
    const pk = match?.pk;
    ...
    return (<Modal title={modalTitle} open={open} onCancel={onClose} width={720} footer={<Space wrap>
      ...
      {computed.bothSidesDnf && (<Typography.Paragraph type="danger">
          双方均有 DNF：无法按成绩自动判胜，请使用下方「直接判定」或重开一局。
        </Typography.Paragraph>)}
      {pk.lastComputed && !computed.bothSidesDnf && (<Typography.Text>
          上次计算：A 队合计{' '}
...
//# sourceMappingURL=PkModal.jsx.map
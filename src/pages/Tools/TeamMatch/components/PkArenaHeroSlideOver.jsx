...
function PkArenaHeroSlideOver({ open, anchor, onClose, settings, data }) {
    ...
    return (<div className="tmPkArenaHeroRoot" role="dialog" aria-modal="true" aria-label="队员详情">
      <button type="button" className="tmPkArenaHeroBackdrop" onClick={onClose} aria-label="关闭"/>
      <div className={classNames('tmPkArenaHeroPanel', `tmPkArenaHeroPanel--${anchor}`, {
        ...
        <div className="tmPkArenaHeroPanelInner">
          ...
          <div className="tmPkArenaHeroAvatarBlock">
            {data.avatarDataUrl ? (<img alt="" src={data.avatarDataUrl} className="tmPkArenaHeroAvatar" style={{ width: av, height: av, borderColor: settings.playerNameColor }}/>) : (<div className="tmPkArenaHeroAvatar tmPkArenaHeroAvatarPh" style={{
                width: av,
                height: av,
                fontSize: av * 0.38,
          ...
          <Typography.Title level={2} className="tmPkArenaHeroName" style={{ color: settings.playerNameColor, fontSize: namePx, margin: 0 }}>
            {data.name}
          </Typography.Title>
          ...
          {data.pkResultLine ? (<div className="tmPkArenaHeroScorePk">
          ...
          {(data.teamBattlecry || '').trim() ? (<div className="tmPkArenaHeroCryBlock">
          ...
          {(data.playerBattlecry || '').trim() ? (<div className="tmPkArenaHeroCryBlock">
              <Typography.Text className="tmPkArenaHeroCryLabel" style={{ fontSize: cryPx }}>
                个人宣言
              </Typography.Text>
              <Typography.Paragraph className="tmPkArenaHeroCryText" style={{ fontSize: cryPx, color: 'rgba(255,255,255,0.9)' }}>
...
//# sourceMappingURL=PkArenaHeroSlideOver.jsx.map
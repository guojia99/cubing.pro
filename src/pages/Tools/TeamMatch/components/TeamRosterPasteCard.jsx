...
const TeamRosterPasteCard = ({ session, dispatch }) => {
    ...
    return (<>
      ...
      <Modal title="粘贴导入（学校、选手、队伍）" open={open} onCancel={() => setOpen(false)} width={920} footer={null} destroyOnClose styles={{ body: { paddingTop: 12 } }}>
...
//# sourceMappingURL=TeamRosterPasteCard.jsx.map
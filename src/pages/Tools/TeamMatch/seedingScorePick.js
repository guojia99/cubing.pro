...
export function pickBestByAverage(wca, one, pre) {
    const cands = [];
...
export function resolveOfficialScores(strategy, wca, one, pre) {
    if (strategy === 'manual')
        return null;
...
export const SEEDING_SOURCE_LABEL = {
    wca: 'WCA',
    one: 'One',
    preliminary: '初赛',
    manual: '手填',
...
export const SEEDING_SOURCE_INLINE = {
    manual: '手动',
    wca: 'wca',
    one: 'one',
    preliminary: '初赛',
};
//# sourceMappingURL=seedingScorePick.js.map
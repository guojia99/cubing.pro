...
export function getDefaultBracketPageSettings() {
    return {
        pageBg: 'transparent',
        scale: 1,
        hintFontPx: 12,
...
export function getDefaultLiveUISettings() {
    return {
        bracket: getDefaultBracketPageSettings(),
        arena: getDefaultPkArenaSettings(),
    };
}
export function loadLiveUISettings() {
    try {
...
export function saveLiveUISettings(s) {
    try {
...
export function bracketSettingsToCssVars(b) {
    return {
...
//# sourceMappingURL=liveUiSettings.js.map
...
const SimpleMinxDraw = () => {
    ...
    const [minxPointsM, setMinxPointsM] = useState([]);
    useEffect(() => {
        const v = [];
    ...
    return (<div>
      <DrawPalette svgPoints={minxPointsM} presetColors={baseMinxColor} storageKey={'SimpleMinxDraw'} viewBox={"0 0 10000 10000"} strokeWidthNum={25}/>
    </div>);
};
const MinxHasCenterDraw = () => {
    ...
    return (<div>
      <DrawPalette svgPoints={minxPointsM} presetColors={baseMinxColor} storageKey={'minx_center_Draw'} viewBox={'0 0 565.4 566.6'} strokeWidthNum={2}/>
    </div>);
};
const MinxDraw = () => {
    const items = [
    ...
    return (<>
      <NavTabs type="line" items={items} tabsKey="minx_draw_tabs" indicator={{ size: (origin) => origin - 20, align: 'center' }}/>
    </>);
};
export default MinxDraw;
//# sourceMappingURL=MinxDraw.jsx.map
...
const SimplePyDraw = () => {
    const [pyPointsM, setPyPointsM] = useState([]);
    const pyPoints = [
        // 左
    ...
    return (<div>
      <DrawPalette svgPoints={pyPointsM} presetColors={baseSkColor} storageKey={'SimplePyDraw'} viewBox={'0 0 471.31 604.31'} strokeWidthNum={10}/>
    </div>);
};
const PyDraw = () => {
    const items = [
    ...
    return (<>
      <NavTabs type="line" items={items} tabsKey="py_draw_tabs" indicator={{ size: (origin) => origin - 20, align: 'center' }}/>
    </>);
};
export default PyDraw;
//# sourceMappingURL=PyDraw.jsx.map
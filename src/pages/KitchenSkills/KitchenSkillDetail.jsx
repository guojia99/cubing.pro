...
const KitchenSkillDetail = () => {
    ...
    useEffect(() => {
        ...
        fetch(TIPS_JSON)
            .then((r) => r.json())
            .then((data) => {
            const tip = data.tips?.find((t) => t.category === cat && t.id === rid);
    ...
    return (<div className="kitchen-skill-detail-page" style={{ padding: 24 }}>
      <div style={{
            marginBottom: 16,
            display: 'flex',
            alignItems: 'center',
        ...
        <Button type="text" icon={<ArrowLeftOutlined />} onClick={() => navigate('/other/kitchen-skills')} style={{ borderRadius: 8 }}>
          返回列表
        </Button>
      </div>
      ...
      <div className="kitchen-skill-detail-layout" style={{ display: 'flex', gap: 24 }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div ref={contentRef} className="markdown-body kitchen-skill-detail-content" style={{
            padding: 24,
            borderRadius: 12,
        ...
        {headings.length > 0 && (<div className="kitchen-skill-detail-anchor" style={{
                width: 200,
                flexShrink: 0,
                position: 'sticky',
                top: 80,
...
//# sourceMappingURL=KitchenSkillDetail.jsx.map
...
export default [
  ...
  { path: 'algs', name: 'Algs', component: './Algs/AlgsList' },
  {
    path: 'algs/:cube/:class',
    name: 'AlgsDetail',
    component: './Algs/AlgsDetail',
    hideInMenu: true,
  },
...

  {
    ...
    routes: [
      ...
      {
        path: 'proportion-estimation',
        component: './WCA/ProportionEstimation',
        name: 'proportionEstimation',
      },
  ...
  { path: 'player/:id', component: './Player/Player' },
  {
    ...
    routes: [
      ...
      { name: 'PKTimer', path: 'pktimer', component: './Static/Pktimers' },
    ],
  },
];
